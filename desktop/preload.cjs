...
contextBridge.exposeInMainWorld('moaonHub', Object.freeze({
  ...
  assistantAutomation:input=>ipcRenderer.invoke('moaon-hub:assistant-automation',input),
  ...
  readStock:()=>ipcRenderer.invoke('moaon-hub:read-stock'),
  ...
  deleteCalendarEntry: entry => ipcRenderer.invoke('moaon-hub:delete-calendar-entry',entry),
  createCalendarEntry: entry => ipcRenderer.invoke('moaon-hub:create-calendar-entry',entry),
  copyEventText: text=>ipcRenderer.invoke('moaon-hub:copy-event-text',text),
  readEventPerformance: id => ipcRenderer.invoke('moaon-hub:read-event-performance',id),
  ...
  updateState: () => ipcRenderer.invoke('moaon-hub:update-state'),
  checkUpdate: () => ipcRenderer.invoke('moaon-hub:update-check'),
  downloadUpdate: () => ipcRenderer.invoke('moaon-hub:update-download'),
  restartForUpdate: () => ipcRenderer.invoke('moaon-hub:update-restart'),
