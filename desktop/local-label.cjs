...
function renderLabel({hubOrderId,trackingNo,receiver={},goodsName,quantity,businessName='',channelLabel=''}={}){
 ...
 @page{size:100mm 150mm;margin:0}*{box-sizing:border-box}body{margin:0;background:#eeeaf4;color:#111;font-family:Pretendard,'Malgun Gothic',sans-serif}.preview-note{max-width:100mm;margin:16px auto;font-size:13px;line-height:1.6;color:#51475e}.label{width:100mm;min-height:150mm;margin:16px auto;background:white;padding:6mm;display:flex;flex-direction:column;gap:5mm;overflow-wrap:anywhere}header{display:flex;justify-content:space-between;gap:8px;padding-bottom:4mm;border-bottom:2px solid #111;font-size:13px}header b{font-size:20px}.receiver small{font-size:12px}.receiver h1{font-size:24px;margin:8px 0}.receiver strong{font-size:18px}.receiver p{font-size:18px;line-height:1.55;margin:10px 0}.goods{border-block:1px solid #aaa;padding:4mm 0;display:grid;gap:8px;font-size:14px}.barcode{margin-top:auto;text-align:center}.trackingBarcode{width:100%;height:20mm;display:block}.barcode b{display:block;letter-spacing:2px;font-size:19px;margin-top:8px}footer{font-size:10px;color:#444}.preview-note,.label{border-radius:10px}@media print{body{background:white}.preview-note{display:none}.label{margin:0;border-radius:0;width:100mm;min-height:150mm}}
...
module.exports={renderLabel,barcodeSvg};
