...
test('IPC registration rejects arguments and untrusted senders before dispatching fixed methods', async () => {
  ...
  const connection = {
    ...
    readInventory: async()=>({status:'READY',items:[]}),
