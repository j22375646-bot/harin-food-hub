...
(async()=>{
 ...
 try{
  ...
  await page.evaluate(()=>{displayedOrders=Object.freeze(displayedOrders.map(order=>({...order,platform:'COUPANG',details:{...order.details,receiver:{}}})));closeOrderDetail();renderOrders();});
