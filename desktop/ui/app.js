...
function showRoute(route, options = {}) {
 if(route==='orders'&&displayMode==='live'&&(!overviewLastAttempt||Date.now()-overviewLastAttempt>60000))void refreshOverview();
  ...
  document.querySelector('#app-breadcrumb-page').textContent=({assistant:'업무비서',today:'오늘',orders:'주문·배송',settlement:'운영·정산',insights:'분석',keywords:'키워드',calendar:'업무 캘린더',events:'이벤트',inventory:'상품',stock:'재고',cs:'고객·CS',settings:'앱 설정'})[route]||'오늘';
