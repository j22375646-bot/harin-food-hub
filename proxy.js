...
function isPublic(pathname) {
  return pathname === '/integrations/moaon-automation.py'
    ...
    || pathname === '/integrations/moaon-company-knowledge.py'
    || pathname === '/integrations/install-moaon-knowledge.py'
    || pathname === '/integrations/install-moaon-routing.py'
    ...
    || pathname === '/api/moaon/assistant/worker'
    || pathname === '/api/moaon/assistant/read'
