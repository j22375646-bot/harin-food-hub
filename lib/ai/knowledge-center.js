...
const PAGE_LABELS = Object.freeze({
  main:'메인', insight:'인사이트', keyword:'키워드', product:'상품', orders:'주문·배송', cs:'CS', inventory:'재고관리', settlement:'정산·비용',
  collection:'데이터수집', notifications:'알림', reports:'진단목록', changes:'변경기록', validation:'실행검증', experiments:'A/B 테스트'
});
...
const RECOMMENDED_DOCUMENTS = Object.freeze([
  ...
  { id:'operation-rule', title:'배송·반품·CS 운영 기준서', category:'CS', reason:'주문 이후 고객 응대와 배송 판단의 공통 원칙', scopes:['orders','cs','inventory'] }
]);
