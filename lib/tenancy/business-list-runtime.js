...
function createBusinessListRuntime({
 ...
 for(const dependency of [createControlDatabase,createIdentityClient,createService])if(typeof dependency!=='function')throw new TypeError('Invalid runtime dependency');
