...
function buildBidKeywordTrendView({analysis={},days=7}={}){
  ...
  if(platform!==NAVER){
    return {platform:platform||null,status:'PLATFORM_MISMATCH',days:range,daily:[],summary:{average_rank:null,latest_rank:null,rank_improvement:null,latest_bid:null,bid_change:null,target_rank:null}};
  }
