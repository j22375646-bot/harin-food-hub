...
const SCHEDULE_FIELDS='ncc_adgroup_id,mode,weekdays,start_minute,end_minute,interval_minutes,max_changes_per_run,daily_change_limit,allow_increase,activation_confirmed_at,last_run_slot,last_run_at,last_run_status,updated_at';
...
module.exports={
  RUN_TABLE,SCHEDULE_FIELDS,SCHEDULE_TABLE,NaverBidScheduleStoreError,
  claimRun,dailyExecutedCount,finishRun,isSetupMissing,listNaverBidSchedules,saveNaverBidSchedule
};
