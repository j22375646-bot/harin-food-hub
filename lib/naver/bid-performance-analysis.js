...
function buildBidOperatingScope({scope={},period={},devicePayload=[],regionPayload=[],errors=[]}={}){
  ...
  return {
    phase:'25-4',formula_version:'phase25-4-operating-scope-v1',platform:'NAVER',
    status:hasDevices&&hasRegions?'READY':hasDevices||hasRegions?'PARTIAL':'NO_DATA',
    ...
    device_status:deviceStatus,region_status:regionStatus,devices,regions,
    sources:{
    ...
    notice:'기기·지역은 실제 성과를 비교하는 분석 범위입니다. 키워드 변경 입찰가는 PC·모바일·지역에 공통 입찰가로 적용됩니다.',
    errors:sourceErrors
  };
}
