...
function buildNaverBidSchedulePlan({schedule:rawSchedule,candidates=[],rules=[],timeSlot=null,now=new Date(),dailyExecutedCount=0,automationEnabled=false}={}){
  const schedule=validateNaverBidSchedule({...rawSchedule,platform:'NAVER'});
...
module.exports={
  ...
  activeTimeSlot,buildEstimateCandidates,buildNaverBidSchedulePlan,kstParts,scheduleDue,scheduleSlot,validateNaverBidSchedule
};
