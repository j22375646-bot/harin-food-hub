...
const CAFE24_EPOST_COURIER_CODE = '0013';
...
function courierCode(platform, value) {
  ...
  if (platform === 'CAFE24') {
    ...
    if ([CAFE24_EPOST_COURIER_CODE, '00004'].includes(candidate)) return CAFE24_EPOST_COURIER_CODE;
    throw Object.assign(new Error('Cafe24 우체국 소포택배 배송사 코드는 0013이어야 합니다.'), { status:400, code:'CAFE24_EPOST_COURIER_INVALID' });
  }
