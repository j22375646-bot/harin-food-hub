...
function metadata(provider,env,fields,row,now=Date.now()){
 ...
 const cfg=require(provider==='CLOVA'?'../ai/clova-client.js':'../ai/gemini-client.js').configuration(env,now),reasonCodes=[];
