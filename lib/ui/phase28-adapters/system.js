...
const CORE_SERVICES=Object.freeze([
  Object.freeze({id:'cafe24',label:'Cafe24',meta:'자사몰 Admin API · OAuth',brand:'CAFE24',tone:'mint',datasets:['상품','주문','문의','클레임','일별 결제·환불 매출','광고 매체·키워드 귀속'],action:'OAuth 읽기 권한과 최근 수집 성공을 확인한 뒤 필요한 작업만 실행해요.'}),
...
const DATASETS=Object.freeze([
  ...
  Object.freeze({id:'finance',label:'정산·광고',sources:['Cafe24','네이버 검색광고','네이버 커머스','쿠팡'],contents:['정산','일별 결제·환불 매출','광고비','광고 유입·주문·매출','캠페인·키워드']}),
