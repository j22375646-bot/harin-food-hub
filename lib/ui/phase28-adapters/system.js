...
function buildPhase28SystemModel(data={}){
  ...
  return Object.freeze({
    generatedAt:data.generatedAt||null,error:text(data.error),writePolicy:'GUARDED',services,workspaces:WORKSPACES,flow:flowModel(services),datasets:DATASETS,jobs,recovery,
