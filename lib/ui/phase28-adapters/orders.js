...
function buildOrderPage(orders=[],events=[],options={}){
  ...
  const candidates=orders.filter(order=>order.fulfillment!=='ROCKET_GROWTH'&&orderStageIds(order).includes(stage))
...
module.exports={buildPhase28OrdersModel,buildOrderPage,invoiceView};
