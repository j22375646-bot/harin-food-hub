...
const {PHASE28_ROUTE_IDS,phase28RouteForLegacyState}=require('./phase28-route-registry.js');
...
function phase28RuntimeForState(env = process.env, state = {}, options = {}) {
  const routeId=phase28RouteForLegacyState(state)?.id||null;
  return phase28RuntimeConfig(env,{...options,routeId});
}
...
module.exports={ booleanFlag, listFlag, phase28UiConfig, phase28RuntimeConfig, phase28RuntimeForState, harinUiConfig };
