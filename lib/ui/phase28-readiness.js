...
function buildPhase28Readiness({routes,hubNav,hubWorkspaces,env={},availableAdapters=[]}){
  ...
  if(!flags.complete)blockers.push({
    code:'INCOMPLETE_PAGE_COVERAGE',
    configuredCount:flags.pages.length,
  ...
  return Object.freeze({
    ...
    cutover:blockers.length||!flags.enabled||!flags.complete?'BLOCKED':'READY',
    flags:Object.freeze({
      enabled:flags.enabled,
      pages:Object.freeze([...flags.pages]),
      valid:flags.valid,
