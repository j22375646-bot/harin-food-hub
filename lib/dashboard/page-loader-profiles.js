...
const KEYWORD_PRODUCT_CORE = ['master_products','channel_products','product_costs','ai_analysis_results'];
const NAVER_KEYWORD_CORE = ['naver_campaigns','naver_adgroups','naver_keywords','naver_keyword_stats','naver_keyword_product_links'];
...
const VIEW_PROFILES = {
  ...
  orders:['cafe24_orders','cafe24_order_items','cafe24_products','cafe24_oauth_tokens','channel_products','naver_commerce_orders','naver_commerce_order_items','coupang_products','coupang_product_items','coupang_orders','coupang_order_items','coupang_rg_orders','coupang_returns','shipping_reference_snapshots','hub_work_items','ai_analysis_results'],
  cs:[
  ...
  inventory:['cafe24_oauth_tokens','coupang_products','coupang_product_items','coupang_rg_inventory','inventory_lots','ai_analysis_results'],
  settlement:['cafe24_orders','cafe24_sales_daily','cafe24_oauth_tokens','naver_commerce_orders','naver_commerce_settlements','naver_stats_daily','naver_bizmoney_daily','raw_api_responses','automation_runs','coupang_orders','coupang_settlements','coupang_rg_orders','coupang_rg_order_items','coupang_settlement_summaries','coupang_cost_transactions','coupang_ad_settlement_daily','channel_cost_settings','channel_shipping_rules','ai_analysis_results'],
...
const WORKSPACE_PROFILES = {
  ...
  keyword:{
    ...
    registered:[...KEYWORD_PRODUCT_CORE,'product_ad_targets','cafe24_oauth_tokens',...NAVER_KEYWORD_CORE,...COUPANG_AD_CORE],
    diagnosis:[...KEYWORD_PRODUCT_CORE,'product_ad_targets','cafe24_oauth_tokens',...NAVER_KEYWORD_CORE,...COUPANG_AD_CORE,'product_detail_checklists'],
    performance:[...KEYWORD_PRODUCT_CORE,'product_ad_targets','cafe24_oauth_tokens',...NAVER_KEYWORD_CORE],
  ...
  product:{
    ...
    mappings:['master_products','channel_products','cafe24_products','coupang_products','coupang_product_items','coupang_item_inventory','product_mapping_history','cafe24_oauth_tokens','ai_analysis_results'],
...
const PLATFORM_TABLES = {
  naver:['naver_campaigns','naver_adgroups','naver_keywords','naver_stats_daily','naver_bizmoney_daily','naver_keyword_stats','naver_search_terms','naver_keyword_product_links','naver_commerce_orders','naver_commerce_order_items','naver_commerce_settlements'],
  ...
  cafe24:['cafe24_orders','cafe24_order_items','cafe24_products','cafe24_traffic_daily','cafe24_referrers_daily','cafe24_sales_daily','cafe24_ad_attribution']
};
...
function supplementalQueryNeedsForState(state={}) {
  const view=state.view||'main';
  return {
    csAudits:view==='cs',
    keywordPeriod:view==='keyword'||view==='changes',
    keywordCount:view==='keyword',
    coupangOrderTerminals:view==='main'||view==='orders',
    reliability:view==='collection'
  };
}
...
module.exports={VIEW_PROFILES,WORKSPACE_PROFILES,profileForState,supplementalQueryNeedsForState,scopeInsightReportQuery,createLoaderSession};
