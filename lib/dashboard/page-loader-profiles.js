...
const VIEW_PROFILES = {
  orders:['cafe24_orders','cafe24_order_items','cafe24_products','channel_products','naver_commerce_orders','naver_commerce_order_items','coupang_products','coupang_product_items','coupang_orders','coupang_order_items','coupang_rg_orders','coupang_rg_order_items','coupang_returns','shipping_reference_snapshots','ai_analysis_results'],
  inventory:['coupang_products','coupang_product_items','coupang_rg_inventory','coupang_item_inventory','ai_analysis_results'],
...
const WORKSPACE_PROFILES = {
  insight:{
    overview:['reports','platform_events','alerts','ai_analysis_results'],
    causes:['reports','actions','platform_events','alerts',...PRODUCT_CORE,...NAVER_AD_CORE,...COUPANG_AD_CORE,'cafe24_orders','cafe24_order_items','naver_commerce_orders','naver_commerce_order_items','coupang_orders','coupang_order_items'],
  ...
  keyword:{
    'search-terms':['master_products','channel_products','naver_keywords','naver_search_terms','naver_keyword_stats','ai_analysis_results'],
    registered:[...PRODUCT_CORE,...NAVER_AD_CORE,...COUPANG_AD_CORE],
    diagnosis:[...PRODUCT_CORE,...NAVER_AD_CORE,...COUPANG_AD_CORE,'product_detail_checklists'],
  ...
  product:{
    ...
    costs:[...PRODUCT_CORE,'cafe24_products','coupang_products','coupang_product_items'],
