...
const WORKSPACE_PROFILES = {
  collection:{
    ...
    overview:[...COLLECTION_READINESS_CORE,'automation_runs','data_quality_checks','ai_analysis_results','coupang_sync_requests','coupang_operation_requests','worker_heartbeats'],
