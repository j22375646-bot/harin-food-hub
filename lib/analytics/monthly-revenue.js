...
const SOURCE_SPECS = Object.freeze([
  ...
  Object.freeze({ key:'NAVER', platform:'NAVER', table:'naver_commerce_orders', dateField:'order_date', fields:'order_id,order_date,payment_date,status,paid_amount' }),
  Object.freeze({ key:'COUPANG', platform:'COUPANG', table:'coupang_orders', dateField:'ordered_at', fields:'shipment_box_id,order_id,ordered_at,paid_at,status,gross_amount' }),
  Object.freeze({ key:'COUPANG_RG', platform:'COUPANG', table:'coupang_rg_orders', dateField:'paid_at', fields:'order_id,status,paid_at,total_amount' })
]);
...
async function fetchMonthlyRevenue(db, month, options = {}) {
  ...
  return { ...summary, month:window.month, counts, issues };
}
