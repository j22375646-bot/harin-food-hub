...
const {isProductCostReady}=require('./cost-readiness.js');
...
function buildMainCashflow({
  ...
  const sales=revenueTotals.ALL!=null&&revenueTotals.ALL!==''&&Number.isFinite(Number(revenueTotals.ALL))?round(revenueTotals.ALL):null;
