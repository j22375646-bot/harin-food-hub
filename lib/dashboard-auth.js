...
async function authenticateAccount({ account, password, ip, userAgent }, db = supabaseModule.getSupabase(), { authClient } = {}) {
  ...
  const [sessionResult] = await Promise.all([
    createDatabaseSession(profile, { ip, userAgent }, db),
