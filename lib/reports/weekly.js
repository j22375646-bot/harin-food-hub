...
async function periodSummary(db, start, end) {
  ...
  const financialTrust = contribution.financial_trust || financialTrustModule.evaluateFinancialTrust({ costCoverageRate:contribution.cost_coverage_rate, requireAdAssignment:false });
