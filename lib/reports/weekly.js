...
async function generateReport(options = {}) {
  ...
  return { created: true, report: reportRow, actions_created: actionsCreated, alerts_created:alertResult.created, alerts_resolved:alertResult.resolved, period, summary };
}
