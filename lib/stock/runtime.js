...
if(value.revision===0){fields.receivedDate=fields.receivedDate||new Intl.DateTimeFormat('sv-SE',{timeZone:'Asia/Seoul'}).format(new Date());fields.receivedQuantity=fields.quantity;fields.receivedUnit=fields.unit;}
else {fields.receivedDate=fields.receivedDate||previous.receivedDate||null;fields.receivedQuantity=previous.receivedQuantity??null;fields.receivedUnit=previous.receivedUnit??null;}
