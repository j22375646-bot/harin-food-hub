...
const HUB_NAV = [
  ...
  { id:'changes', group:'execution', label:'변경기록', href:'/approvals', icon:'A', description:'실행·검증·복구 기록' },
...
const HUB_NAV_GROUPS = [
  ...
  { id:'execution', label:'실행', icon:'E', description:'진단·변경·결과 검증', items:['reports','changes','validation','experiments','notifications'] },
