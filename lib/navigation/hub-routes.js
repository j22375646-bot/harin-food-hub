...
const HUB_NAV = [
  ...
  { id:'market', group:'development', label:'시장·전환', href:'/market-intelligence', icon:'M', description:'상품별 시장·경쟁·전환' },
...
const HUB_NAV_GROUPS = [
  ...
  { id:'development', label:'개발', icon:'B', description:'시장전환·실험·결과 검증', items:['market','validation','experiments'] },
