...
const HUB_WORKSPACES = {
  ...
  insight:[
    ...
    { id:'causes', label:'원인 분석', description:'기존 주소 호환 · 성과 요약으로 이동', href:'/insights/causes' },
    { id:'saved', label:'저장 인사이트', description:'주간 보고서와 상세 근거', href:'/insights/saved' },
    ...
    { id:'diagnostics', label:'누적 진단', description:'수시·자동·주간 진단 기록', href:'/insights/diagnostics' }
  ],
  keyword:[
