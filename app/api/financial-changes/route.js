...
export async function POST(request) {
  ...
  try {
    ...
    const result = await financialChanges.createPreview(body, { idempotencyKey:request.headers.get('idempotency-key') || body.idempotency_key, actor:authModule.requestActor(request) });
