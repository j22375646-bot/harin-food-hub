...
const normalizedReceiver=receiverModule.normalizeReceiver;
...
export async function GET(request) {
  ...
  try {
    ...
    if(!receiver||!receiver.name && !receiver.contact && !receiver.address)return apiSafety.json({ok:false,error:'배송정보가 아직 생성되지 않았습니다.'},{status:404});
