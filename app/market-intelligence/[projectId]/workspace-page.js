...
export async function renderMarketWorkspace({projectId,workspace}){
  ...
  return <HarinPageFrame kind="analysis" className={`marketWorkspace marketWorkspace-${workspace}`}>
    ...
    {workspace==='data'?<><MarketProductBaseline projectId={project.id} productName={productName}/><MarketOfficialEvidence projectId={project.id} productName={productName}/><MarketResearchEvidence projectId={project.id} productName={productName}/><MarketNaverEvidenceSearch projectId={project.id} productName={productName}/><MarketDataRoom projectId={project.id} productName={productName}/></>:workspace==='market'?<><MarketContextEvidence projectId={project.id} productName={productName}/><MarketNaverTrend projectId={project.id} productName={productName}/><MarketNaverAdResearch projectId={project.id} productName={productName}/><MarketNaverCommerceOrders projectId={project.id} productName={productName}/><MarketProfileWorkbench projectId={project.id} productName={productName}/></>:workspace==='competition'?<CompetitionWorkbench projectId={project.id} productName={productName}/>:workspace==='conversion'?<ConversionStage projectId={project.id} productName={productName}/>:<HarinCard className="marketStageEmpty">
