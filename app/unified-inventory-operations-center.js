...
export default function UnifiedInventoryOperationsCenter({ coupang = {}, aiPanel }) {
  ...
  return <HarinPageFrame kind="operations" className="inventoryOpsCenter inventoryOpsV8 inventoryRocketGrowthOnly" data-inventory-scope="coupang-rocket-growth">
    ...
    <details className="inventoryOpsHelp"><summary>도움말 · 어떤 상품만 보이나요?</summary><div><p><b>최근 30일 판매와 판매가능 재고가 모두 있는 상품</b>만 표시합니다. 판매중단·판매 0개·판매가능 0개 SKU와 Cafe24·네이버·판매자배송 재고는 섞지 않아요.</p><p><b>입고 미리보기</b>는 현재 판매가능 수량과 최근 30일 판매속도를 사용합니다. 목표 보유일을 바꿔도 쿠팡 재고나 입고 요청에는 반영되지 않습니다.</p></div></details>
  </HarinPageFrame>;
}
