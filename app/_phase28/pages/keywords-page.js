...
function RoasPair({row}){
  return <span className="kpRoasPair"><span data-missing={row.roas7d==null}><small>최근 7일</small><strong>{percent(row.roas7d)}</strong></span><span data-missing={row.roasToday==null}><small>당일</small><strong>{percent(row.roasToday)}</strong></span></span>;
}
