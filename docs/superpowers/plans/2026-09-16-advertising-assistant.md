...
Fourth increment: same-period parent/revision comparisons across desktop, HTML and Telegram. Comparable coverage and campaign identity required; missing data is held. Actual unchanged-result verification recorded in P4-197.
