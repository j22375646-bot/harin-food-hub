...
| P1-04-13 / 1.56.0 후보 | 내부 로그아웃 처리기와 가명 자료의 로그인·추가 인증·로그아웃 연결 검증 진행. 기존 운영 인증 유지 | [실행 계약](./2026-09-08-moaon-p1-04-13-session-lifecycle.md), [개발 보고서](./2026-09-08-moaon-p1-04-13-development-report.md) |
