...
| 개발 번호 | 개발 내역 | 상태와 근거 |
|---|---|---|
| P4-54 / 진행 중 · 0.38.1 | 출고용 PC·실제 프린터·우체국 발급/플랫폼 등록 인수, 주문 마감 | 프린터 구분·안내 보완, 단위230개·패키지 프린터/발급/등록 UI 통과. 목록 밀도 검사 미통과·별도 PC 실출고 인수 미실행. [보고서](./2026-09-09-moaon-p4-54-shipping-acceptance-report.md) |
