...
| P1-04-12 / 1.55.0 후보 | 저장된 추가 인증과 복구 검토 요청의 실제 연결, 대기 중 폐기 재검사 구현·검증 진행. 운영 비활성 | [실행 계획](./2026-09-08-moaon-p1-04-12-proof-integration.md), [개발 보고서](./2026-09-08-moaon-p1-04-12-development-report.md) |
