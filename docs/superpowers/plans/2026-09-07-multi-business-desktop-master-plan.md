...
| P1-04-9 / 1.51.0 | 복구 검토 요청의 세션 인증·출처·크기·시간 제한. 검증 및 배포 진행 중, 공개 경로·새 인증/SQL 미활성 | [실행 계획](./2026-09-08-moaon-p1-04-9-request-boundary.md), [개발 보고서](./2026-09-08-moaon-p1-04-9-development-report.md) |
