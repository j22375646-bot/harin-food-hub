...
**최신: P5-12 실제 설치·재실행 인수.** 이 PC의 0.9.0을 **0.13.1로 실제 업데이트**했고 설치 전후 프로필 파일 133개 변경·누락 0개, 실제 설치 EXE 두 차례 실행·기존 다크모드 유지·메인/설정 이동을 확인했다. 실제 로그인 유효성과 물리 프린터 인수는 남아 있다. [P5-12 상세 결과·다음 단계](./2026-09-08-moaon-p5-12-installed-acceptance-report.md)
