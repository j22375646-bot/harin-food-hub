...
| 개발 번호 | 개발 내역 | 상태와 근거 |
|---|---|---|
| P4-54 / 진행 중 · 0.38.2 | 출고용 PC·실제 프린터·우체국 발급/플랫폼 등록 인수, 주문 마감 | 프린터 구분·안내 및 목록 밀도 보완 완료. 단위230개·패키지UI8종·설치본 정렬/패널 통과. 별도 PC 실출고 인수 미실행. [최신 보고서](./2026-09-09-moaon-p4-54-order-density-report.md) |
