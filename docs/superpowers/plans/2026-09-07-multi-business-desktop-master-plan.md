...
| P1-04-5 / 1.47.0 UNRELEASED 후보 | Task 1 대상별 DB 요청 제한은 로컬 구현·검증 완료. Task 2 복구 검토 이력은 PENDING이며 P1-04-5 전체·운영 배포는 미완료. 실제 인증 전환과 관리자 검토 화면은 별도 | [실행 계획](./2026-09-08-moaon-p1-04-5-request-controls.md), [진행 보고서](./2026-09-08-moaon-p1-04-5-development-report.md) |
