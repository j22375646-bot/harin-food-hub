...
| 개발 번호 | 개발 내역 | 상태와 근거 |
|---|---|---|
| P4-54 / 진행 중 · 0.38.3 | 출고용 PC·실제 프린터·우체국 발급/플랫폼 등록 인수, 주문 마감 | 프린터·밀도·배송정보 누락 보완. 최신 단위230개·패키지UI5종 통과. 별도 PC 실출고 인수 미실행. [최신 보고서](./2026-09-09-moaon-p4-54-delivery-completeness-report.md) |
