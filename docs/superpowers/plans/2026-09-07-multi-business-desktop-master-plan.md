...
| P1-04-5 / 1.47.0 UNRELEASED 후보 | 대상별 DB 요청 제한·복구 검토 이력 로컬 구현·검증 완료. 독립 검토·최종 빌드·배포 진행 중. 실제 인증 전환과 관리자 검토 화면은 별도 | [실행 계획](./2026-09-08-moaon-p1-04-5-request-controls.md), [진행 보고서](./2026-09-08-moaon-p1-04-5-development-report.md) |
