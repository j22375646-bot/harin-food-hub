...
**최신: P5-13 / 0.14.0 출고 PC 프린터 점검.** 프린터는 다른 출고용 PC에서 사용함을 사용자 확인. 로그인 없는 로컬 프린터 점검 기능과 설치파일 준비, 110개 테스트 및 패키징 코드 점검 통과. 출고 PC 원격 설치/실제 출력은 미실시다. [P5-13 기능·설치 안내·다음 단계](./2026-09-08-moaon-p5-13-shipping-pc-report.md)
