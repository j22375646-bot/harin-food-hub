...
| P5 EXE·발급·출력 | 진행 중 | 조회용 0.10.0 산출물 기록. 현재 P5-09 발급 연결 준비, 실제 앱 발급·프린터·업데이트 검수/G5는 미완료 |
...
**현재 집중:** P5-09. 서버 발급 전 재검증은 운영 적용 기록이 있고, PC 작업 기록·재시작 복구·연결 해제 차단·고정 통신 adapter는 내부 코드와 테스트까지다. 통신 adapter와 작업 코어의 합성 응답 통합 시험은 통과했지만, 실제 인증 세션/IPC/확인 UI에 연결하지 않았다. 아직 설치된 EXE에 실제 발급 버튼을 연결하지 않았다.
...
**바로가기:** [최신 개발 보고서](./2026-09-08-moaon-p5-09-transport-report.md) · [Windows 세부 계획](./2026-09-07-windows-private-hub-roadmap.md) · [최근 조회용 0.10.0 인도 기록](./2026-09-08-moaon-p5-09-review-filters-handoff.md)
...
| P5-09 고정 통신 adapter (이번) | 고정 주소·주문 제한·응답 제한·취소 및 작업 코어 통합 | 내부 구현/합성 응답 시험 완료, 실제 인증 세션/EXE 미연결 — [보고서](./2026-09-08-moaon-p5-09-transport-report.md) |
