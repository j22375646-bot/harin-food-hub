...
| P1-04-14 / 1.57.0 | 허용 출처·쿠키·실패 응답을 다루는 내부 로그아웃 요청 경계. 검증 결과는 보고서에 기록. 공개 인증 전환은 미활성 | [실행 계약](./2026-09-08-moaon-p1-04-14-logout-request.md), [개발 보고서](./2026-09-08-moaon-p1-04-14-development-report.md) |
