...
test('custom market runtime environment reaches both control runtime and Gemini configuration',async()=>{
 ...
 const sandbox={module:{exports:{}},process:{env:{SOURCE:'process-only'}},require(name){
  ...
  if(name==='./workspace-market-ai-request')return {guardMarketAiRequest:()=>{},createMarketAiRequest:options=>options};
 ...
 const service=captured.createService({database:{},identityDb:{},authAdmin:{}});
