...
test('the production client root ships only the Phase 28 application boundary',()=>{
  ...
  assert.match(source,/import Phase28App from '\.\/_phase28\/phase28-app\.js'/);
  assert.doesNotMatch(source,/next\/dynamic|Phase28Loading/);
...
test('every route page is split out of the initial Phase 28 client bundle',()=>{
  const source=fs.readFileSync(path.join(root,'app','_phase28','phase28-app.js'),'utf8');
  for(const file of [
    'home-page.js','calendar-page.js','orders-page.js','cs-page.js','inventory-products-page.js',
    'settlement-page.js','keywords-page.js','product-analysis-page.js','insights-page.js','system-page.js',
    'notifications-page.js','diagnoses-page.js','changes-page.js','validation-page.js','experiments-page.js','knowledge-page.js'
  ]){
