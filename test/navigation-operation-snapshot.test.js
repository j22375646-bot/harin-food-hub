...
test('navigation snapshot keeps the newest fresh authoritative value',()=>{
  ...
  assert.equal(snapshotModule.parseNavigationOperationSnapshot(JSON.stringify(newer),Date.parse('2026-08-23T03:20:00.000Z')),null);
});
